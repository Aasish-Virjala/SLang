...
public class FirstSpeech extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_first_speech);
        ...
        switch (requestCode) {
            case 10:
                if(resultCode==RESULT_OK && data != null) {
                    ...
                    startActivity(new Intent(FirstSpeech.this, secondActivity.class));
                }
